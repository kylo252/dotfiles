...
M.mappings = {
  ...
  g = {
    ...
    k = { require_safe("gitsigns").prev_hunk, "Prev Hunk" },
    l = { require_safe("gitsigns").blame_line, "Blame" },
    p = { require_safe("gitsigns").preview_hunk, "Preview Hunk" },
    r = { require_safe("gitsigns").reset_hunk, "Reset Hunk" },
    s = { require_safe("gitsigns").stage_hunk, "Stage Hunk" },
    u = { require_safe("gitsigns").undo_stage_hunk, "Undo Stage Hunk" },
    R = { require_safe("gitsigns").reset_buffer, "Reset Buffer" },
