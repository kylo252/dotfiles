...
local keymap = {
    E = {
        "<cmd>lua require\"config.telescope\".scope_browser()<CR>",
        "Open scope browser"
    },
    f = {
        name = "+Find",
        ...
        d = {
            name = "+dotfiles",
            d = {
                "<cmd>lua require\"config.telescope\".find_dotfiles()<CR>",
                "Open dotfiles"
            },
            s = {
                "<cmd>edit ~/.config/nvim/lua/settings.lua<CR>",
                "Edit nvim settings"
            },
            p = {
                "<cmd>edit ~/.config/nvim/lua/settings.lua<CR>",
...
require("telescope").setup {
    defaults = {
        ...
        find_command = {
            "rg", "--no-heading", "--with-filename", "--hidden",
